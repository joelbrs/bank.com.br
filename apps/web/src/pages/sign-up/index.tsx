import { Button, Form, FormControl, FormField, FormItem, FormMessage, Input, Label } from "@repo/ui/components";
    ...
    return (
        <div className="lg:p-8 space-y-10">
            ...
            <div className="grid gap-6">
                <Form {...form}>
                    <form className="space-y-2.5" onSubmit={form.handleSubmit(console.log)}>
                        <FormField 
                        ...
                        <FormField 
                            ...
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Nome" id="firstname" {...field}/>
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <div className="flex items-center gap-2">
                            <FormField 
                                ...
                                render={({field}) => (
                                    <FormItem className="w-full">
                                        <FormControl>
                                            <InputPassword label="Senha" id="password" maxLength={20} {...field}/>
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField 
                                ...
                                render={({field}) => (
                                    <FormItem className="w-full">
                                        <FormControl>
                                            <InputPassword label="Confirme a Senha" id="passwordConfirmation" maxLength={20} {...field}/>
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
